...
HD_PWD='/root/Development/microblaze_uart/microblaze_uart.runs/design_1_rst_mig_7series_0_83M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_mig_7series_0_83M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_mig_7series_0_83M_1.tcl
