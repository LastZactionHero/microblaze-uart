...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_uartlite_1_UART [get_bd_intf_ports UART_0] [get_bd_intf_pins axi_uartlite_1/UART]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins rst_clk_wiz_0_166M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_166M_peripheral_aresetn [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins rst_clk_wiz_0_166M/peripheral_aresetn]
